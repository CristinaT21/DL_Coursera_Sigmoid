...
def augment_nested_images(data_dir, output_dir, brightness=0.1, contrast=0.1, degrees=10, num_augmentations=1):
        ...
        for file in files:
            ...
            try:
                ...
                for i in range(num_augmentations):
                    ...
                    print(f"Augmented image size: {augmented_image.size}, mode: {augmented_image.mode}")
